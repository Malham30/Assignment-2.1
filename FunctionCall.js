function play() {
    //These lines bellow give value to the different variables created
    ...
    //this creates an if else statement that helps tel wheter or not the person wins or loses
    if (sum == 7 || sum == 11) {
...
alert(result);
    document.getElementById("Average").innerHTML = "Average = " + result;
}